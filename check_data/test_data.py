...
def test_column_presence_and_type(
        data: Union[FixtureFunctionMarker, _FixtureFunction]
) -> None:
    """Test if all needed columns are contained in the input artifact."""
    ...
    required_columns = {
        ...
        "duration_ms": pd.api.types.is_integer_dtype,  # This is integer, not float
        # as one might expect
    ...
    for col_name, format_verification_funct in required_columns.items():
        assert format_verification_funct(data[col_name]), (f"Column {col_name}"
                                                           f" failed test "
                                                           f"{format_verification_funct}")


def test_class_names(
        data: Union[FixtureFunctionMarker, _FixtureFunction]
) -> None:
    """Test for the correct data types in the input artifact."""
...
def test_column_ranges(
    ...
    """Test for the correct ranges in the input artifact."""
...
def test_kolmogorov_smirnov(
        data: Union[FixtureFunctionMarker, _FixtureFunction],
        ks_alpha: Union[FixtureFunctionMarker, _FixtureFunction]
) -> None:
    """Test for the X`s distributions in the input artifact."""
